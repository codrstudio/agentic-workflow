...
```bash
# Adicionar componentes necessarios
...
### Exemplo real: Drawer mobile → Sheet desktop

Referencia: `packages/ui/src/components/color-theme-drawer.tsx`
...
### Exemplo real: Drawer mobile → Popover desktop

Referencia: `packages/ui/src/components/notifications/notification-panel.tsx`
...
O Drawer herda as animacoes spring do Vaul automaticamente. Customizar:

```tsx
<Drawer
  shouldScaleBackground={true}  // Escala do conteudo atras (0 = sem, 1 = max)
  closeThreshold={0.25}         // Distancia de threshold para fechar
>
```
...
<Drawer shouldScaleBackground={!prefersReduced}>
```
